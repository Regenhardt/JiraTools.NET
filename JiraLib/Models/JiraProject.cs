...
public record JiraProject(Uri Self, int Id, string Key, string Name, string ProjectTypeKey, Dictionary<string, Uri> AvatarUrls, ProjectCategory ProjectCategory);